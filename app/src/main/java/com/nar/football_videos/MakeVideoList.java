package com.nar.football_videos;
...
public class MakeVideoList {
	...
	public static void createMyAlbums(){
		...
		addVideoItem("bjUlSj1Mn7w", " Film Pele Birth of a Legend (2016)", "Watch in this Film Pele Birth of a Legend (2016)");
		...
		createPlayList("Pele", R.drawable.pele1);
		...
		createPlayList("Maradona", R.drawable.maradona1);
		//==========================================================================
		...
		createPlayList("Beckham", R.drawable.beckham1);
		//==========================================================================
		...
		addVideoItem("tHDf60BNI_c", "Lionel Messi ● 20 LEGENDARY Goals", "Lionel Messi Best Goals Ever || Literally The Greatest Solo Goals Ever Scored in Football History");

		addVideoItem("tF2_bIpqFYg", "17 Impossible Things Only Messi Can Do this", "Watch in this video the 17 Impossible Things Only Messi Can Do this");
		...
		createPlayList("Messi", R.drawable.messi1);
		//==========================================================================
		...
		addVideoItem("LqRIBRMaUvs", "ToP 10 Goals By Cristiano Ronaldo That Shocked The Whole World", "Watch in this video the ToP 10 Goals By Cristiano Ronaldo That Shocked The Whole World");
		...
		addVideoItem("mV0PLaXxt0E", " Cristiano Ronaldo Master of the Skill", "Watch in this video the Cristiano Ronaldo Master of the Skill");
		...
		addVideoItem("t00j8NDH6gU", "", "");

		createPlayList("Cristiano", R.drawable.cr71);
		//==========================================================================

//6==========================================================================

		addVideoItem("Pq2aujxWC1w", "Neymar Jr - The Master Of Penalty", "Some of Neymar's best penalties in high quality. Including moments against great goalkeepers");
		...
		createPlayList("Neymar Jr", R.drawable.nymer1);
		//==========================================================================
...
//11==========================================================================
		...
		addVideoItem("NxtFt2DQoT4", "Karim BENZEMA'S Legendary  Goals Real Madrid", "Karim BENZEMA'S Legendary  Goals Real Madrid");
		...
		//14==========================================================================
		addVideoItem("7zRSqKZNJdA", "Mohamed Salah is Unstoppable Goals", "Watch in this video the Mohamed Salah is Unstoppable Goals");
		...
		createPlayList("Aguero", R.drawable.aguero);
...
//16==========================================================================
		...
		addVideoItem("ln35qLphK4I", "Zlatan Ibrahimovic ● Craziest Skills Ever ● Impossible Goals", "Watch in this video the Zlatan Ibrahimovic ● Craziest Skills Ever ● Impossible Goals");

		addVideoItem("ln35qLphK4I", "Legend Zlatan Ibrahimovic ● Craziest Skills Ever ● Impossible Goals", "Watch in this video the Legend Zlatan Ibrahimovic ● Craziest Skills Ever ● Impossible Goals");

		addVideoItem("T45cOq4OWVc", "55 Times When Legend Zlatan Ibrahimovic Lose Control", "Watch in this video the 55 Times When Legend Zlatan Ibrahimovic Lose Control");
...
//20==========================================================================
		...
		addVideoItem("fRmJuiy_Y6w", "Johan Cruijff- Legendary goals/skills/passing ", "Watch in this video the Johan Cruijff- Legendary goals/skills/passing");
...
//25==========================================================================
		...
		addVideoItem("2MZxzZOd308", "Erling Haaland Legendary ● Goals & Skills", "Watch in this video the Erling Haaland Legendary ● Goals & Skills");
...
//26==========================================================================
		...
		addVideoItem("gyRQXuEimgo", "Harry Kane Mind blind Goals", "Watch in this video the Harry Kane Mind blind Goals");
...
//30==========================================================================
		...
		addVideoItem("x19fcRTQOYY", "Robert Lewandowski Legendary 18 Goals", "Watch in this video the Robert Lewandowski All 18 Goals");
		...
		addVideoItem("TfaRnmM0srA", "Luka Modric Best Skills & Goals, Assists", "Watch in this video the Luka Modric Best Skills & Goals, Assists");
		...
		//34==========================================================================
		addVideoItem("UsHoeAjzsnE", "Sadio Mane Magical Skills & Legendary Goals", "Sadio Mane Magical Skills & Legendary Goals 2021/2022");
		...
		addVideoItem("m8mzVYER32g", "WOW! Sadio Mane Unbelievable Moments That Surprised The World", "WOW! Sadio Mane Unbelievable Moments That Surprised The World");

		addVideoItem("zRDxzmpfId4", "Sadio Mané 15 LEGENDARY GOALS", "Sadio Mane- 15 magical and rare moments of 2022");

		addVideoItem("6RKAG3sFu2k", "19 AMAZING GOALS Sadio Mane SHOCKED The World", "See the 19 amazing goals Sadio Mane stunned the world with");

		addVideoItem("zPWTkKokgWU", "Sadio Mane Legendary Goals for Bayern Munich", "OMG! Watch Sadio Mane unstoppable scoring goals for Bayern Munich");
		...
		addVideoItem("eYk-H9FJjs4", "Sadio Mane | Crazy Skills, Goals & Assists", "Sadio Mane | Crazy Skills, Goals & Assists 2023");
...
//36==========================================================================
		...
		addVideoItem("ARTvM-rPeVI", "LEGENDARY Moment by Manuel Neuer", "Watch in this video the LEGENDARY Moment by Manuel Neuer");

		addVideoItem("x7qg7YPJB8Y", "legend MANUEL NEUER THE BEST", "Legend MANUEL NEUER - 2022 - THE BEST");
...
//40==========================================================================
		addVideoItem("2JPS7NDblpA", "Paul Pogba Best Skills & Goals, Assists", "Watch Paul Pogba 2021/22 Best Skills & Goals, Assists");
...
//41==========================================================================
		...
		addVideoItem("5UcCqT_Ibc0", "Sergio Ramos - THE END", "Sergio Ramos - THE END | 2005-2021");
